...
import com.deyvidsantos.emailsender.appuser.AppUserRole;
import com.deyvidsantos.emailsender.appuser.AppUserService;
import com.deyvidsantos.emailsender.email.EmailSender;
...
public class RegistrationService {
     ...
     *
     * @param request o objeto de solicitação de registro
     * @return o token de confirmação gerado
     */
    ...
    /**
     * Confirma um token de confirmação.
     *
     * @param token o token de confirmação a ser confirmado
     * @return a confirmação bem-sucedida
     */
    @Transactional
    ...
    /**
     * Constrói o conteúdo do email de confirmação.
     *
     * @param name o nome do destinatário
     * @param link o link de ativação da conta
